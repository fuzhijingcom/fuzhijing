...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link href="./i_files/css" rel="stylesheet" type="text/css">
        <style>
            html, body {
                overflow: hidden;
                margin: 0;
        ...
        <script type="text/javascript" async="" src="./i_files/ga.js.下载"></script><script type="text/javascript">
    ...
    <body>
        ...
        <canvas width="1680" height="919"></canvas>
        <script>
